...
public class DbSearcher {
    ...
    /**
     * get the region with templates int ip address with memory binary search algorithm
     *
     * @param ip
     * @throws IOException
     */
    ...
    /**
     * get the region with templates int ip address with b-tree algorithm
     *
     * @param ip
     * @throws IOException
     */
    ...
    /**
     * get the region with templates int ip address with binary search algorithm
     *
     * @param ip
     * @throws IOException
     */
